    ...
    try {
      ...
      if (result.success) {
        setFormData({
          ...
          venueNameArabic: result.data.venueNameArabic || '',
    ...
    <Box sx={{ p: isSmallScreen ? 2 : 3, backgroundColor: theme.palette.grey[100], minHeight: '100vh', width: '100%' }}>
      <Box sx={{
        ...
        <Box component="form" onSubmit={handleSubmit}>
          <Tabs value={tabValue} onChange={handleTabChange} aria-label="venue name tabs">
              ...
              <CardContent sx={{ '&:last-child': { pb: 2 } }}>
                ...
                <TabPanel value={tabValue} index={2}>
                  <TextField
                    ...
                    name="venueNameArabic"
                    value={formData.venueNameArabic}
                    onChange={handleInputChange}
